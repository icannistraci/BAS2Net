...
# data_dir = './train_data/DUTS/DUTS-TE/'  # set the data directory,
...
gt_dir = 'gt_pascal'  # set the ground truth folder name
rs_dirs = ['basnet_final_pascal', 'bas2net_final_pascal']  # set the folder names of different methods
